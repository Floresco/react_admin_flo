        ...
        <div className="container-fluid">
            ...
            <div className="row">
                ...
                <div className="col-lg-5">
                    <div className="card-style mb-30">
                        <div
                            className="title d-flex flex-wrap align-items-center justify-content-between"
                        >
                            <div className="left">
            ...
            <div className="row">
                ...
                <div className="col-lg-7">
                    <div className="card-style mb-30">
                        <div
                            className="title d-flex flex-wrap justify-content-between align-items-center"
                        >
                            <div className="left">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div className="product">
                                            <div className="image">
                                                <img
                                                    src="../../template/assets/images/products/product-mini-1.jpg"
                                                    alt=""
                                                />
                                            </div>
                                        ...
                                        <div className="action justify-content-end">
                                            ...
                                            >
                                                <li className="dropdown-item">
                                                    <a href="index.html#0" className="text-gray">Remove</a>
                                                </li>
                                                <li className="dropdown-item">
                                                    <a href="index.html#0" className="text-gray">Edit</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div className="product">
                                            <div className="image">
                                                <img
                                                    src="../../template/assets/images/products/product-mini-2.jpg"
                                                    alt=""
                                                />
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div className="product">
                                            <div className="image">
                                                <img
                                                    src="../../template/assets/images/products/product-mini-3.jpg"
                                                    alt=""
                                                />
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div className="product">
                                            <div className="image">
                                                <img
                                                    src="../../template/assets/images/products/product-mini-4.jpg"
                                                    alt=""
                                                />
                                            </div>
