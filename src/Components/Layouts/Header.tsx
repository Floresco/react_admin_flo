                    ...
                    <div className="header-right">
                        <div className="notification-box ml-15 d-none d-md-flex">
                            ...
                            >
                                <li>
                                    <a href="index.html#0">
                                        <div className="image">
                                            <img src="../../template/assets/images/lead/lead-6.png" alt=""/>
                                        </div>
                              ...
                              comment on a product.
                                ...
                                <li>
                                    <a href="index.html#0">
                                        <div className="image">
                                            <img src="../../template/assets/images/lead/lead-1.png" alt=""/>
                                        </div>
                                        <div className="content">
                                            <h6>
                                                Jonathon
                        ...
                        <div className="header-message-box ml-15 d-none d-md-flex">
                            ...
                            >
                                <li>
                                    <a href="index.html#0">
                                        <div className="image">
                                            <img src="../../template/assets/images/lead/lead-5.png" alt=""/>
                                        </div>
                                        <div className="content">
                                            <h6>Jacob Jones</h6>
                                ...
                                <li>
                                    <a href="index.html#0">
                                        <div className="image">
                                            <img src="../../template/assets/images/lead/lead-3.png" alt=""/>
                                        </div>
                                        <div className="content">
                                            <h6>John Doe</h6>
                                ...
                                <li>
                                    <a href="index.html#0">
                                        <div className="image">
                                            <img src="../../template/assets/images/lead/lead-2.png" alt=""/>
                                        </div>
                                        <div className="content">
                                            <h6>Anee Lee</h6>
                        ...
                        <div className="profile-box ml-15">
                            ...
                            >
                                ...
                                <li>
                                    <a href="index.html#0"> <i className="lni lni-inbox"></i> Messages </a>
                                </li>
                                <li>
                                    <a href="index.html#0"> <i className="lni lni-cog"></i> Settings </a>
                                </li>
                                <li>
                                    <a href="index.html#0"> <i className="lni lni-exit"></i> Sign Out </a>
                                </li>
                            </ul>
                        </div>
                    </div>
