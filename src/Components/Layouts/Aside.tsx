...
export default function Aside() {
    return <aside className="sidebar-nav-wrapper">
            ...
            <ul>
              ...
              <span className="icon">
                <svg width="22" height="22" viewBox="0 0 22 22">
                  ...
                  <span className="text">
                    Analytics <span className="pro-badge">Pro </span>
                  </span>
                            </a>
                        </li>
                        <li>
                            <a href="crypto.html">
                  <span className="text">
                    Crypto <span className="pro-badge">Pro </span>
                  </span>
                            </a>
                        </li>
                        <li>
                  ...
                  <span className="text">
                    CRM <span className="pro-badge">Pro</span>
                  </span>
                            </a>
                        </li>
                    </ul>
              ...
              <span className="icon">
                ...
                >
                  ...
                  <span className="text">
                    Projects <span className="pro-badge">Pro</span>
                  </span>
                            </a>
                        </li>
                        <li>
                            <a href="clients.html">
                  <span className="text">
                    Clients <span className="pro-badge">Pro</span>
                  </span>
                            </a>
                        </li>
                        <li>
                            <a href="pricing.html">
                  <span className="text">
                    Pricing <span className="pro-badge">Pro</span>
                  </span>
                            </a>
                        </li>
                        <li>
                            <a href="chat.html">
                  <span className="text">
                    Chat <span className="pro-badge">Pro</span>
                  </span>
                            </a>
                        </li>
                        <li>
              ...
              <span className="icon">
                ...
                >
                  ...
                  />
                        ...
                        <span className="text">
                Kanban <span className="pro-badge">Pro</span>
              </span>
                    </a>
                </li>
                <li className="nav-item">
              ...
              <span className="icon">
                ...
                >
                  ...
                  />
                        ...
                        <span className="text">
                File Manager <span className="pro-badge">Pro</span>
              </span>
                    </a>
                </li>
                <li className="nav-item">
              ...
              <span className="icon">
                ...
                >
                  ...
                  />
                        ...
                        <span className="text">
                Profile <span className="pro-badge">Pro</span>
              </span>
                    </a>
                </li>
                <li className="nav-item">
              ...
              <span className="icon">
                ...
                >
                  ...
                  />
                        ...
                        <span className="text">
                Task <span className="pro-badge">Pro</span>
              </span>
                    </a>
                </li>
                <li className="nav-item">
              ...
              <span className="icon">
                ...
                >
                  ...
                  />
                        ...
                        <span className="text">
                Calendar <span className="pro-badge">Pro</span>
              </span>
                    </a>
                </li>
                <li className="nav-item nav-item-has-children">
                  ...
                  />
                    ...
                    <ul id="ddmenu_4" className="collapse dropdown-nav">
                        ...
                        <li>
                            <a href="modals.html">
                  <span className="text">
                    Modals <span className="pro-badge">Pro</span>
                  </span>
                            </a>
                        </li>
                        <li>
                            <a href="tabs.html">
                  <span className="text">
                    Tabs <span className="pro-badge">Pro</span>
                  </span>
                            </a>
                        </li>
                        <li>
              ...
              <span className="icon">
                ...
                >
                  ...
                  <span className="text">
                    Form Layout <span className="pro-badge">Pro</span>
                  </span>
                            </a>
                        </li>
                    </ul>
                ...
                <li className="nav-item">
                    <a href="https://demo.plainadmin.com/tables.html">
              <span className="icon">
                <svg
                    width="22"
                    height="22"
              ...
              <span className="icon">
                ...
                >
                  ...
                  />
                        ...
                        <span className="text"> Form Plugins </span>
                    </a>
                    <ul id="ddmenu_77" className="collapse dropdown-nav">
                        <li>
                            <a href="form-edit.html">
                  <span className="text">
                    QuillJs <span className="pro-badge">Pro</span>
                  </span>
                            </a>
                        </li>
                        <li>
                  ...
                  <span className="text">
                    Form Validation <span className="pro-badge">Pro</span>
                  </span>
                            </a>
                        </li>
                    </ul>
              ...
              <span className="icon">
                ...
                >
                  ...
                  <span className="text">
                    Basic Table <span className="pro-badge">Pro</span>
                  </span>
                            </a>
                        </li>
                        <li>
                  ...
                  <span className="text">
                    Responsive Table <span className="pro-badge">Pro</span>
                  </span>
                            </a>
                        </li>
                        <li>
                  ...
                  <span className="text">
                    Data Table <span className="pro-badge">Pro</span>
                  </span>
                            </a>
                        </li>
                    </ul>
              ...
              <span className="icon">
                ...
                >
                  ...
                  <span className="text">
                    ChartJs <span className="pro-badge">Pro</span>
                  </span>
                            </a>
                        </li>
                        <li>
                  ...
                  <span className="text">
                    Apex Chart <span className="pro-badge">Pro</span>
                  </span>
                            </a>
                        </li>
                    </ul>
